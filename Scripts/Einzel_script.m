function [ outstring ] = Einzel_script()
...
prompt={'First frame';'Last frame';'Background noise (photons)';...
    ...
    'Pixel to photon ratio';'rbox';'rball';...
