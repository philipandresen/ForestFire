function [ outstring ] = test_script_alpha()
...
pix_to_pho=inputdlg('Pixel to photon ratio','Background calculation');

outstring={['pix_to_pho=' pix_to_pho{:} ';'];...
    'bkgn=bkgn_selector(original_files,pix_to_pho);'};
