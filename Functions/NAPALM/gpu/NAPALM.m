...
function [fname]=NAPALM(n_start,n_end,bkgn,q,...
...
%spmd
    ...
    for frame_index=1:num_frames
        ...
        background1 = double(imopen(temp1,se));
        background2 = double(imopen(temp2,se));
...
%spmd
    ...
    pixel_rcfi_sorted=SearchAndDestroy(IMAGE_merged,min_thresh,rbox+rbox2);
